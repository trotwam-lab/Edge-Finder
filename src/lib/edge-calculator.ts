...
import { sumImpact } from "@/lib/injuries";
...
function areOppositeOutcomes(a: BestOdds, b: BestOdds): boolean {
  ...
  // Spread pairing: points must be equal-and-opposite.
  // e.g. "Chiefs +3" pairs with "Eagles -3".
...
// Uses sumImpact() from injuries.ts to avoid duplicate logic.
// ============================================================
